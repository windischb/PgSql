...
namespace doob.PgSql.Interfaces.Where.Typed
{
    public interface ITypedWhereClauseLogicalAnd<T>
    {
        ...
        ITypedWhereClauseConnectionAnd<T> Any(string propertyName, params object[] value);
        ...
        ITypedWhereClauseConnectionAnd<T> Like(string propertyName, string value, bool ignoreCase);
        ...
        ITypedWhereClauseConnectionAnd<T> Any<TField>(Expression<Func<T, TField>> expression, params object[] value);
